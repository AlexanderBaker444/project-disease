...
fig.update_layout(height=1000, width=800, title_text="First subplot compare the weater between the two cities, then the number of cases for each city correlated with the dew temperature.")
fig.show()
